              ...
              <div className="auth-wrapper">
                ...
                <h3>Sign Up</h3>
                    ...
                    <div className="form-group">
                        ...
                        <input type="password" name="CustomerPassword"  noValidate onChange={this.handleChange} maxLength="10" value={this.state.CustomerPassword} className="form-control" placeholder="Enter password" />
