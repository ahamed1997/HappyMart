...
BEGIN
	...
	set @Id = @TempSubCategoryId + 'SC' + (FORMAT(@Count,'00000'));
	set @TempPrice = (SELECT FORMAT ( @money,'C', 'ta-IN'));
	insert into Product values (@Id,@TempSubCategoryId,@Name,@Description,@Specification,@TempPrice,@Brand,@IsActive,@ImageURL);
END
GO
