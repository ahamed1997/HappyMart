...
AS
BEGIN
	declare @Id varchar(10),@TempId int, @Count int,@ProductCount int,@CustomerId varchar(30),@ProductId varchar(50) ;
	...
	set @ProductCount = (select count(1) from Cart where CustomerId = @CustomerId 
