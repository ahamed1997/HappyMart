...
BEGIN
	...
	BEGIN
		...
		set @encryptedPaymentDetailsCardNumber =SELECT CONVERT(varchar(50), CONVERT(varbinary(max),@PaymentDetailsCardNumber))
		set @encryptedPaymentDetailsCardNumber = EncryptByPassPhrase('key', @encryptedPaymentDetailsCardNumber);
