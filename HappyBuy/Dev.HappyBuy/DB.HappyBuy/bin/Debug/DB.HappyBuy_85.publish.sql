...
CREATE TABLE [dbo].[PaymentDetails] (
    ...
    [PaymentDetailsCardNumber]     INT             NULL,
...
CREATE PROCEDURE [dbo].[USP_PlaceOrder]
	...
	@PaymentDetailsCardHolderName int,
	@PaymentDetailsExpiryMonth int,
	@PaymentDetailsExpiryYear int,
	@PaymentDetailsCVV int,
	@OrderDetailsPrice Decimal
AS
BEGIN
	DECLARE @OrderId INT, @OrderDetailsId INT,@CurrentDate DATETIME,@PaymentId int,@PaymentDetailsId int;
	set @OrderId = (SELECT COUNT(*) from Orders)+1;
	set @CurrentDate = (Select CONVERT(varchar,GETDATE(),103) as [DD/MM/YYYY]);
	INSERT into Orders values (@OrderId,@OrdersCustomerId,@OrdersShippingAddressId,@OrdersOrderStatusId,@CurrentDate);
