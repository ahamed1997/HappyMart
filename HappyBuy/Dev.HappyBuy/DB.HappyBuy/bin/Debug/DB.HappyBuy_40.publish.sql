...
declare @Id varchar(10),@null varchar(10),@Count int
set @Count = (select count(*) from Customer) + 1;
set @Id = 'HBCUS' + (FORMAT(@Count,'000000000'));
...
AS
BEGIN
declare @Id varchar(10),@TempId int;
set @TempId = (select count(*) from Category) + 1;
