...
AS
BEGIN
	declare @Id varchar(10),@Count int, @TempCategoryId varchar(10);
	set @Count = (select count(*) from SubCategory)+1;
	set @Id = @CategoryId + 'SC' + (FORMAT(@Count,'00000'))
	set @TempCategoryId = (select Id from Category where Id = @CategoryId);
